  ...
  const mockData = [
    {
      ...
      sideEffects:
        "Feeling sick (nausea) or being sick (vomiting), stomach cramps, and diarrhoea.",
      precautions:
...

    {
      ...
      description:
        "It works by blocking histamine, a substance released by the body during an allergic reaction. It belongs to a group of medications called antihistamines.",
      ...
      precautions:
        "Do not take Allegra with fruit juice (such as apple, orange, or grapefruit). There may be other drugs that can affect Allegra.",
      interactions:
...

    {
      ...
      description:
        "A hormone and neurotransmitter produced by the adrenal glands.",
      ...
      precautions:
        "Injecting the medication intravenously or into the buttocks is not recommended.",
      interactions:
...

    {
      ...
      sideEffects:
        "Hypoglycemia (low blood sugar level), altered taste, nausea, stomach pain, diarrhea, headache and upper respiratory tract infection.",
      precautions:
...

    {
      ...
      description:
        "It's a type of biologic drug, specifically a TNF-alpha inhibitor, meaning it works by blocking a protein called tumor necrosis factor (TNF) that plays a role in inflammation.",
...

    {
      ...
      description:
        "An ACE (angiotensin converting enzyme) inhibitor used to treat high blood pressure (hypertension), congestive heart failure, kidney problems caused by diabetes, and to improve survival after a heart attack.",
      ...
      sideEffects:
        "Dry, tickly cough. Cough medicines do not usually help coughs caused by enalapril.",
      precautions:
        "Call a doctor right away if you have a rash, itching, hoarseness, trouble breathing, trouble swallowing, or any swelling of your hands, face, or mouth while you are using this medicine.",
      interactions:
...

    {
      ...
      description:
        "It is a type of angiotensin-converting enzyme (ACE) inhibitor. Also called lisinopril and Zestril.",
...

    {
      ...
      description:
        "A corticosteroid nasal spray that decreases inflammation in your nose.",
      uses: "Used to treat nasal polyps in adults aged 18 and over.",
      sideEffects:
...

    {
      ...
      description:
        "It works by reducing the amount of acid in the stomach. It belongs to a group of medications called PPIs.",
      ...
      precautions:
        "Call your doctor right away if you have severe bone pain or are unable to walk or sit normally.",
...

    {
      ...
      description:
        "A white to practically white fine powder. It is soluble in ethanol and methanol and slightly soluble in water.",
      ...
      precautions:
        "Tell your healthcare provider about any prescription or over-the-counter (OTC) medicines, vitamins/minerals, herbal products, and other supplements you are using.",
      interactions:
...

    {
      ...
      description:
        "Belongs to a class of medications called benzodiazepines. It is thought that benzodiazepines work by enhancing the activity of certain neurotransmitters in the brain.",
      uses: "Used to treat insomnia caused by anxiety or temporary situational stress.",
      sideEffects:
...

    {
      ...
      description:
        "A nonsteroidal anti-inflammatory drug (NSAID) used to treat pain or inflammation caused by arthritis.",
      ...
      sideEffects:
        "Chest pain or discomfort, nausea or vomiting, pain or discomfort in the arms, jaw, back, or neck, trouble breathing, slurred speech, or weakness. Meloxicam may cause bleeding in your stomach or bowels. ",
      precautions:
        "This medication may increase your risk of developing stomach and intestinal problems.",
      interactions:
...

    {
      ...
      precautions:
        "This medicine may cause drowsiness, trouble with thinking, trouble with controlling movements, or trouble with seeing clearly.",
...

    {
      ...
      precautions:
        "It is very important that your doctor check your or your child's progress at regular visits to make sure the medicine is working properly and to decide if you should continue to take it.",
...

    {
      ...
      precautions:
        "Make sure you know how you react to this medicine before you drive, use machines, or do anything else that could be dangerous if you are not alert, well-coordinated, or able to think or see well.",
      interactions:
...

    {
      ...
      description:
        "A medication that prevents and treats fungal or yeast infections. It's a type of antifungal medication.",
      uses: "Used to treat infections caused by fungus, which can invade any part of the body including the mouth, throat, esophagus, lungs, bladder, genital area, and the blood.",
      sideEffects: "Headache, rest and drink plenty of fluids.",
      precautions:
...

    {
      ...
      precautions:
        "Never use Valium in larger amounts, or for longer than prescribed. Tell your doctor if you feel an increased urge to use more of this medicine.",
      interactions:
...

    {
      ...
      description:
        "A prescription medication that helps prevent asthma attacks in people aged 12 months and over.",
      ...
      precautions:
        "Montelukast may cause some people to be agitated, disoriented, irritable, or display other abnormal behaviors.",
      interactions:
...

    {
      ...
      description:
        "An alpha-blocker medication that treats the symptoms of an enlarged prostate.",
...

    {
      ...
      description:
        "This medicine works by stopping your liver from making cholesterol.",
      uses: "Used together with a proper diet to treat high cholesterol and triglyceride (fat) levels in the blood.",
      sideEffects:
        "Dark-colored urine, loss of appetite, weight loss, general feeling of tiredness or weakness, light-colored stools, upper right stomach pain, or yellow eyes or skin.",
      precautions:
...

    {
      ...
      precautions:
        "Avoid drinking alcohol before and during treatment with fenofibrate.",
      interactions:
...

    {
      ...
      precautions:
        "Call a doctor right away if you have unexplained muscle pain, tenderness, or weakness especially if you also have fever, unusual tiredness, or dark urine.",
...

    {
      ...
      description:
        "An antimetabolite drug that is used to treat some cancers, severe skin diseases such as severe psoriasis, and to treat forms of rheumatoid arthritis.",
...

    {
      ...
      description:
        "A medication that treat high blood pressure. It relaxes your blood vessels.",
      uses: "Used to treats high blood pressure",
...

    {
      ...
      description:
        "An anthranilic acid derivative that is used as a strong diuretic in adults and children to treat excessive fluid accumulation (edema) caused by congestive heart failure, liver failure, renal failure, and nephritic syndrome.",
...

    {
      ...
      precautions:
        "This medicine may cause fluid retention edema in some patients.",
      interactions:
...

    {
      ...
      description:
        "A calcium channel blocker. It works by affecting the movement of calcium into the cells of the heart and blood vessels.",
...

    {
      ...
      description:
        "A type of medicine known as a calcium channel blocker (CCB). It is used to treat high blood pressure (hypertension) and a type of chest pain called angina.",
      ...
      precautions:
        "Check with your doctor right away if you or your child have pain or tenderness in the upper stomach, pale stools, dark urine, loss of appetite, nausea, vomiting, or yellow eyes or skin.",
      interactions:
...

    {
      ...
      description:
        "A beta-blocker that affects the heart and circulation (blood flow through arteries and veins). Tenormin is used to treat angina (chest pain) and hypertension (high blood pressure).",
...

    {
      ...
      description:
        "A selective, hydrophilic beta-adrenoreceptor blocking agent with mild intrinsic sympathomimetic activity for use in treating patients with hypertension and ventricular arrhythmias.",
      uses: "Used to treat hypertension (high blood pressure) and heart rhythm disorders.",
      sideEffects:
        "Blurred vision, chest tightness, cold hands or feet, confusion.",
      precautions:
...

    {
      ...
      description:
        "Belongs to a group of medicines called beta blockers. Trandate works by causing the heart to beat more slowly and with less force.",
      uses: "Used to treat high blood pressure (hypertension), including high blood pressure in pregnancy.",
      sideEffects:
        "tingling scalp or skin, tiredness, headache, nausea, upset stomach, stuffy nose.",
      precautions: "This medicine may cause heart failure in some patients.",
      interactions:
...

    {
      ...
      description:
        "An angiotensin II receptor blocker (sometimes called an ARB). Telmisartan keeps blood vessels from narrowing, which lowers blood pressure and improves blood flow.",
...

    {
      ...
      description:
        "The first of a new class of agents for the treatment of hypertension, is an angiotensin II receptor (type AT1) antagonist.",
...

    {
      ...
      description:
        "Medicine that is used to treat high blood pressure (hypertension).",
      uses: "Used to treat high blood pressure.",
      sideEffects:
        "Feeling sleepy, tired and weak. Make sure you rest and allow your body time to get used to clonidine.",
      precautions:
...

    {
      ...
      description:
        "A class of medications called glycopeptide antibiotics. It works by killling bacteria in the intestines.",
      uses: "Used to treat serious infections for which other medicines may not work.",
      sideEffects:
        "Continuing ringing or buzzing or other unexplained noise in the ears, and cough or hoarseness.",
      precautions:
...

    {
      ...
      description:
        "A type of antibiotic that treats infections caused by bacteria.",
...

    {
      ...
      description:
        "Treats infections caused by bacteria. It belongs to a group of medications called antibiotics.",
...

    {
      ...
      description:
        "A macrolide antibacterial drug indicated for mild to moderate infections caused by designated, susceptible bacteria.",
      uses: "Used to treats infections caused by bacteria.",
      sideEffects:
        "Skin rash, itching, hives, swelling of the face, eyes, lips, tongue, arms, or legs, trouble swallowing or breathing. ",
      precautions:
        "This medicine may increase the risk of serious heart or blood vessel problems.",
...

    {
      ...
      description:
        "A sterile, semisynthetic, broad-spectrum cephalosporin antibiotic for intravenous or intramuscular administration.",
      uses: "Used to treat many kinds of bacterial infections, including severe or life-threatening forms such as meningitis.",
      sideEffects:
        "Injection site reactions (swelling, redness, pain, a hard lump, or soreness), loss of appetite.",
      precautions:
        "Do not take any medicine or give medicine to your child to treat diarrhea without first checking with your doctor.",
      interactions:
...

    {
      ...
      description:
        "An antibiotic used to treat certain infections caused by bacteria. It works by killing the bacteria that cause the infection.",
      uses: "Used to treat bacterial infections in many different parts of the body.",
      sideEffects:
        "Trouble breathing, trouble swallowing, or any swelling of your hands, face, or mouth.",
      precautions:
        "Do not take other medicines unless they have been discussed with your doctor.",
...

    {
      ...
      description:
        "An oral prodrug of the bactericidal cephalosporin antibiotic cefuroxime.",
      uses: "Used to treat a wide variety of bacterial infections.",
      sideEffects:
        "Candida overgrowth, eosinophilia, headache, dizziness, gastrointestinal disturbances, and transient liver enzyme elevations.",
      precautions:
        "Do not take any medicine or give medicine to your child to treat diarrhea without first checking with your doctor.",
      interactions:
...

    {
      ...
      description:
        "It belongs to the class of medicines known as cephalosporin antibiotics. It works by killing bacteria or preventing their growth.",
      uses: "Used to treat bacterial infections in many different parts of the body.",
      sideEffects:
        "Abdominal or stomach pain blistering, peeling, or loosening of the skin.",
      precautions:
        "Do not take other medicines unless they have been discussed with your doctor.",
      interactions:
...

    {
      ...
      description:
        "A type of penicillin antibiotic. It works by stopping the growth of bacteria.",
      uses: "Used to treat a wide variety of bacterial infections.",
      sideEffects:
...

    {
      ...
      description:
        "It kills certain bacteria by preventing them from being able to create their cell wall.",
      uses: "Used to treat bacterial infections.",
      sideEffects: "Diarrhea, nausea, vomiting, or rash.",
      precautions:
        "Do not use ampicillin unless it has been prescribed to you by a healthcare provider.",
...

    {
      ...
      description:
        "A penicillin-type antibiotic indicated in the treatment of infections caused by penicillinase-producing staphylococci which have demonstrated susceptibility to the drug",
      uses: "Used to treat infections caused by certain bacteria.",
      sideEffects:
...

    {
      ...
      description:
        "Ciprofloxacin belongs to the class of drugs known as quinolone antibiotics. It works by killing bacteria or preventing their growth.",
      uses: "Used to treat bacterial infections in many different parts of the body.",
      sideEffects:
        "Redness or discomfort in the eye, and bad taste in the mouth.",
      precautions:
...

    {
      ...
      sideEffects: "Upset stomach, dry mouth, and drowsiness.",
      precautions:
        "Should not be taken for longer than 7 to 10 consecutive days unless otherwise directed by your doctor.",
...

    {
      ...
      description:
        "Prescription nonsteroidal anti-inflammatory drug (NSAID) that reduces inflammation and relieves pain.",
...

    {
      ...
      description:
        "A widely used prescription nonsteroidal anti-inflammatory drug (NSAID).",
...

    {
      ...
      description:
        "Can ease heartburn, while the prescription version can treat gastroesophageal reflux disease (GERD) and other conditions involving too much stomach acid.",
      uses: "Used to treat gastric and duodenal ulcers, erosive esophagitis, and gastroesophageal reflux disease.",
      sideEffects:
        "Headaches and stomach-related side effects, such as nausea, gas, or diarrhea.",
      precautions:
        "Taking Prilosec long-term may cause you to develop stomach growths called fundic gland polyps.",
      interactions:
...

    {
      ...
      description:
        "An antihistamine used to treat the symptoms of allergies, such as sneezing, watery eyes, and runny nose.",
      uses: "Used to treat sneezing, runny nose, watery eyes, hives, skin rash, hay fever, itching, and other cold or allergy symptoms.",
      sideEffects:
        "Headache, dizziness, and digestive side effects such as nausea.",
...

    {
      ...
      description:
        "A medication that treats mild to moderate pain and inflammation.",
      uses: "Used to relieve some symptoms caused by arthritis, such as inflammation, swelling, stiffness, and joint pain.",
      sideEffects:
        "Stomach upset, upper respiratory infection, and diarrhea. Gas, abdominal pain, and swelling are also possible.",
      precautions:
        "This medication can cause serious ulcers and bleeding in the stomach. It can happen with no warning.",
      interactions: "May interact with anticoagulants like warfarin.",
      notFor:
...

    {
      ...
      description:
        "An antibiotic that is used for infections caused by certain bacteria.",
      uses: "Use to treat the infections of the ears, nose, throat, urinary tract, and skin.",
      sideEffects:
        "Can cause a severe allergic reaction, trouble breathing. swelling of your throat or tongue.",
      precautions:
        "Do not use Amoxil if you are allergic to amoxicillin or to any other penicillin antibiotic.",
      interactions:
...

    {
      ...
      uses: "To prevent blood clots forming in hardened blood vessels (a process known as atherothrombosis) which can lead to events such as stroke, heart attack or death.",
      sideEffects:
        "Stomach ache, diarrhoea, nausea (feeling sick), and indigestion.",
      precautions:
        "You may need to stop using this medicine at least 5 days before a surgery, medical procedure, or dental work.",
      interactions:
...

    {
      ...
      description:
        "Indicated for the prevention and relief of nausea, dizziness and vomiting associated with motion sickness.",
...

    {
      ...
      description:
        "Taking these medicines together helps if you have diarrhoea with painful stomach cramps and bloating.",
      uses: "Acute non-specific diarrhea. Chronic diarrhea associated with inflammatory bowel disease.",
      sideEffects:
        "Dry mouth, abdominal pain, distention or discomfort, nausea, vomiting, fatigue, flatulence, dyspepsia, constipation.",
      precautions:
...

    {
      ...
      precautions:
        "You should not use this medicine if you are allergic to Robitussin.",
      interactions:
...

    {
      ...
      precautions:
        "Ranitidine has been withdrawn from the market due to safety concerns.",
      interactions:
...

    {
      ...
      description:
        "A prescription inhaled medicine used to treat or prevent bronchospasm in people aged 4 years and older with reversible obstructive airway disease.",
      ...
      sideEffects:
        "Rash, hives, swelling of your face, mouth, and tongue breathing problems.",
      precautions:
        "On demand use of Salbutamol (Ventolin) should not exceed four times daily.",
      interactions:
...

    {
      ...
      description:
        "A biguanide hypoglycemic agent used in the treatment of Non-Insulin-Dependent Diabetes Mellitus.",
      uses: "It helps control blood sugar levels and thus prevents serious complications of diabetes.",
      sideEffects:
        "Stomach ache, loss of appetite, and a metallic taste in the mouth.",
      precautions:
        "Do not take if you are pregnant or have liver, kidney problems.",
...

    {
      ...
      description:
        "It is scientifically proven to remove phlegm and bacteria that causes cough.",
      uses: "Treat cough with phlegm.",
      sideEffects: "Nausea, stomach discomfort, diarrhea, and skin rashes.",
      precautions:
        "If patient is pregnant or breastfeeding, consult her doctor before using this product.",
      interactions:
...

    {
      ...
      sideEffects:
        "Heartburn, constipation, abdominal pain, bloating, dizziness, bleeding gums, diarrhea, and blurred vision.",
      precautions:
        "Do not take advil if you have a stomach ulcer, or have had one in the past.",
